# -*- coding: utf-8 -*-
"""
Created on Tue May 20 13:30:35 2025
...
total_intercept = intercept_wg+intercept_dairy+intercept_fish+intercept_fruit+intercept_veg+intercept_meat+intercept_nut+intercept_legume
# DALY CONSTRAINTS 
...
objective = cp.Minimize(daly_expr)
...
burden_optimal =  {
    ...
    "BURDEN": [burden_ihd, burden_crc, burden_t2d, burden_stroke, burden_hyper]
}
df = pd.DataFrame(burden_optimal)
print(df)
print('TOTAL BURDEN', burden_TOTAL)
